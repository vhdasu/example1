...
class AdminEvents extends PureComponent { 
 ...
 { 
  ...
  return (
    ...
    <div className="adminevents"> 
      ...
      <table class="mytable">
        ...
        <tbody >
          {this.props.adminevents.map((Event, index) => {
            return (
  ...
  render() {
    ...
    return ( (this.state === null) || (typeof(this.state.adminevents) === 'undefined')  || this.state.adminevents === null) ? (<span> ...</span>) : this.renderAdminEvents() ;
